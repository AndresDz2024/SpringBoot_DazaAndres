...
public class ProductmanagementApplication {
	...
	public static void main(String[] args) {
		...
		while (menu) {
			...
			System.out.println("Estás en: " + establecimiento.getNombre() + " \n" +
			...
			switch (choice) {
				...
				case 2 -> {
					...
					System.out.println("Ingrese los datos para el item:");
				...
				default -> System.out.println("Opción no válida bro intente de nuevo.");
			}
		}
		scanner.close();
	}
